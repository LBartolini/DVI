...
<body>
    ...
    <div class="body-text">
        ...
        <p>The main area of research at <b>Campus DVI</b> is Cybersecurity. Our goal is making infrastructures and critical application more secure and resilient to cyber attacks.</p>
        <p>We manage the network that handles the Energy Management System of the whole campus. Our technicians operate on every node from a <b>Windows Machine</b> in a subnetwork.</p>
